  ...
  const fetchEmployees = async () => {
    ...
    try {
      ...
      const transformedData: EmployeeData[] = data.map((employee: any) => ({
        ...
        licenses: 0, // These would be fetched separately in a real app
        documents: 0,
        inductions: 0,
        alerts: [],
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="mt-8 flex items-center justify-between">
        <div className="text-sm text-gray-700">
          Showing <span className="font-medium">1</span> to <span className="font-medium">3</span> of <span className="font-medium">247</span> employees
        </div>
        <div className="flex space-x-2">
