...
export default async function LicenseTrackingPage() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-semibold mb-2">License Tracking</h1>
      <p className="text-gray-600 mb-6">Monitor and manage all employee licenses and certifications with automated expiry alerts.</p>
